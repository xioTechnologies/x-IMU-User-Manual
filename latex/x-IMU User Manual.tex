...
\title{\Huge x-IMU User Manual 5.0 \normalsize}
...
\begin{table}[H]
	\centering
		...
		Pin       &   I/O           & Description\\
		\hline
        AX0       &   Input  & Digital I/O\\
        AX1       &   Input  & Digital I/O\\
        AX2       &   Input  & Digital I/O\\
        AX3       &   Input  & Digital I/O\\
        AX4       &   Input  & Digital I/O\\
        AX5       &   Input  & Digital I/O\\
        AX6       &   Input  & Digital I/O\\
        AX7       &   Input  & Digital I/O\\
		\hline
		\end{tabular}
		\caption{Auxiliary port pin assignments in digital I/O mode}
	\label{tab:AuxiliaryPortPinAssignmentsInDigitalIOmode}
